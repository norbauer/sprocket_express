module Map
  ...
  def self.carrier_codes_to_carrier_names 
    { 'AP' => "USPS International Air parcel or Air Letter",
  ...
  def self.carrier_codes
    self.carrier_codes_to_carrier_names.keys
  end
  
  def self.carrier_names_to_carrier_codes  
    self.carrier_codes_to_carrier_names.invert
  end
  
  # Countries ########################################################################
  
  def self.country_codes_to_country_names
    { '001' => "United States",
      '002' => "Afghanistan",
      '003' => "Albania",
      '004' => "Algeria",
  ...
  def self.country_names_to_country_codes
    self.country_codes_to_country_names.invert
  end

  # CSV Columns ########################################################################
                        
  def order_attributes_to_csv_column_names                       # Comments below come from the original Sprocket sample CSV
      { :alt_num                               => 'AltNum',      # Not used. Please leave blank
  ...
  def self.csv_column_names
    self.order_attributes_to_csv_column_names.values
  end
  
  def self.csv_column_names_to_order_attributes
