...
class Map
 ...
 CSV_STORAGE_PATH = "lib/sprocket_fulfillment/csv_files"  
 
 #Hash of Carrier codes
 CARRIER_CODES = {'AP' => "USPS International Air parcel or Air Letter",
  ...
  # Mapping of the methods of models to the columns in CSV. Also added the specification for the columns provieded in the example file.
  MAPPING = [
